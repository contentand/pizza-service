...
//        list.addAmount(new Status[]{NEW, IN_PROGRESS});
//        list.addAmount(new Status[]{NEW, CANCELLED});
//        list.addAmount(new Status[]{IN_PROGRESS, CANCELLED});
//        list.addAmount(new Status[]{IN_PROGRESS, DONE});
//        return list;
//    }
//
//    @DataPoints("IST")
...
//        List<Order.Status[]> list = new ArrayList<>();
//        list.addAmount(new Status[]{NEW, NEW});
//        list.addAmount(new Status[]{IN_PROGRESS, NEW});
//        list.addAmount(new Status[]{IN_PROGRESS, IN_PROGRESS});
//        list.addAmount(new Status[]{CANCELLED, NEW});
//        list.addAmount(new Status[]{CANCELLED, IN_PROGRESS});
//        list.addAmount(new Status[]{CANCELLED, CANCELLED});
//        list.addAmount(new Status[]{CANCELLED, DONE});
//        list.addAmount(new Status[]{DONE, NEW});
//        list.addAmount(new Status[]{DONE, IN_PROGRESS});
//        list.addAmount(new Status[]{DONE, CANCELLED});
//        list.addAmount(new Status[]{DONE, DONE});
//        return list;
//    }
//
//    @Test
...
//        pizzas.addAmount(new Pizza(1, "Margarita", new BigDecimal("123.40"), Pizza.Type.VEGETARIAN));
//        pizzas.addAmount(new Pizza(1, "Margarita", new BigDecimal("123.40"), Pizza.Type.VEGETARIAN));
//        pizzas.addAmount(new Pizza(2, "Hawaii", new BigDecimal("170.00"), Pizza.Type.MEAT));
...
//        // given
//        List<Pizza> pizzas = new ArrayList<>();
//        pizzas.addAmount(new Pizza(1, "Margarita", new BigDecimal("123.4"), Pizza.Type.VEGETARIAN));
//        pizzas.addAmount(new Pizza(1, "Margarita", new BigDecimal("123.4"), Pizza.Type.VEGETARIAN));
//        pizzas.addAmount(new Pizza(2, "Hawaii", new BigDecimal("170"), Pizza.Type.MEAT));
//        pizzas.addAmount(new Pizza(2, "Hawaii", new BigDecimal("170"), Pizza.Type.MEAT));
//        pizzas.addAmount(new Pizza(2, "Hawaii", new BigDecimal("170"), Pizza.Type.MEAT));
//        Order order = new Order(1L, customer, pizzas);
//
